...
* **Creating a URL and action for html_... method (Ilter) - completed.
...
* **Creating a URL and action for json_... method (Ilter) - completed.
...
* **Creating a JS Stub generator (Naman) - Ilter
...
* **Implementing the stub generator for html_... method (Naman) - Ilter
